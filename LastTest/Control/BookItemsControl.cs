...
{
    public partial class BookItemsControl : UserControl
    {
        public Tovar tovar;
        public BookItemsControl(Tovar tovar)
        {
            InitializeComponent();
            this.tovar = tovar;
            ShowBook();
        ...
        public void ShowBook()
        {
            ...
            label2.Text = "Категория: " + tovar.CategoryName + " Автор: " + tovar.AuthorName + " Жанр: " + tovar.GenreName;
